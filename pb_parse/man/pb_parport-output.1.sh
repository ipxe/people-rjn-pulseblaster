...
SEE_ALSO=( "pulseblaster (1)" "pb_utils (1)" "pb_test-parport (1)" "hawaiisim (1)" "gtkwave (1)" "pbsrc (5)" "vliw(5)" "pbsim (5)" /usr/local/share/doc/pb_parse/simulation.txt )
