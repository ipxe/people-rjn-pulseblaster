...
BINARY="fudge.sh See: /usr/local/share/doc/pb_parse/pbsim.txt"

#Description: brief string for the start of the man page.
DESCRIPTION="the PulseBlaster simulation replay log file format"

#Synopsis text, or leave blank to omit. Add leading spaces to avoid automatic paragraph formatting.
SYNOPSIS=`cat <<-EOT
A .pbsim file is a recording of the output of a simulated PulseBlaster.
It is designed for simple parsing, and to be replayed into the simulator of the connected hardware,
thus correctness-testing the entire chain.
EOT`
...
SEE_ALSO=( "pb_parse (1)" "hawaiisim (1)" )
