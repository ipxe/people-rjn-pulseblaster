...
#Program name.
NAME="pb_serial_trigger_check"

#The binary, (relative path to this script). Invoked with "-h" for help text (stdout or stderr)
BINARY=../src/pb_serial_trigger_check.sh

#Description: brief string for the start of the man page.
DESCRIPTION="check for presence of the pulseblaster serial-port trigger-adapter"
