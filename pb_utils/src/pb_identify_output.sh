...
#This is really part of the driver package, since it tests only the driver, by directly interfacing
#with /sys, and does not use any of the pb_utils (or pb_parse) systems. But it is sufficiently useful
#(for debugging attached equipment) to justify including a copy with pb_utils.
